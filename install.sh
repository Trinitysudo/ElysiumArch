...
confirm_installation() {
    ...
    echo ""
    print_info "Target System Configuration:"
    print_info "  • CPU: AMD Ryzen 5700X"
    print_info "  • GPU: NVIDIA RTX 3060 (drivers will be installed)"
    print_info "  • RAM: 16GB"
    print_info "  • Storage: 500GB NVME SSD"
    echo ""
